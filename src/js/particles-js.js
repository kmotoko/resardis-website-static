'use strict';
/* eslint-disable camelcase, max-len, new-cap, no-case-declarations, no-inner-declarations */
...
// The original library lives in github.com/VincentGarreau/particles.js
// This version is modified from:
// https://github.com/mmacheerpuppy/particles.js/tree/48e9e8b8e78e91f672b1cf3ea5a2950a8c6091a6
// which has fps limiting that improves performance by a great deal
...
const pJS = function (tag_id, params) {
    ...
    pJS.fn.particle.prototype.draw = function () {
        ...
        let radius, opacity, color_value;
    ...
    /* on hover event */
        let dx_mouse, dy_mouse, dist_mouse;
        ...
        } else if (pJS.interactivity.events.onclick.enable && isInArray('bubble', pJS.interactivity.events.onclick.mode)) { /* on click event */
            let time_spent;
...
// Particles.JS config starts here //
window.particlesJS('particles-js', {
    fps_limit: 25, // Do not set this high for performance reasons
    particles: {
    ...
    // retina detection is computationally intensive and has issues in chrome
    retina_detect: false,
});
